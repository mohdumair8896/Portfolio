...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center pt-32 pb-10 px-6 z-10 font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-5xl mx-auto text-center mt-10">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 md:gap-3 px-4 py-1.5 rounded-full bg-slate-900/40 border border-slate-700/50 backdrop-blur-md mb-8 md:mb-12"
        >
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.8)] animate-pulse shrink-0"></span>
          <span className="text-xs font-semibold text-slate-200">DevOps & Cloud Professional</span>
          <span className="text-slate-600">|</span>
          <span className="text-xs text-slate-400">@ Akal Info Sys</span>
          <span className="text-slate-600 hidden sm:inline">|</span>
          <span className="text-xs text-slate-400 hidden sm:inline">2+ yrs</span>
        </motion.div>
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight text-white mb-6 leading-[1.1]"
        >
          I build the <span className="relative inline-block font-serif italic text-[#e9d5ff] font-normal px-2">
            infrastructure
        ...
        <motion.p 
          ...
          className="text-slate-400 text-sm md:text-base max-w-3xl mb-10 leading-relaxed px-4"
        >
      ...
      <motion.div 
        ...
        className="w-full max-w-[1400px] mx-auto mt-auto"
      >
